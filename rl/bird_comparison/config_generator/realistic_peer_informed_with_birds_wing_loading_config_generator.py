...
class RealisticPeerInformedWithBirdsWingLoadingConfigGenerator:
    ...
    def _create_thermal_bird_config(self, thermal_meta: ThermalMeta,
        ...
        defaults = [{
            ...
            'realistic_peer_informed_with_birds_initial_conditions'
        }, {
        ...
        experiment_id = f'peer_informed_with_birds_{thermal_meta.name}_{bird_name_lower}'
